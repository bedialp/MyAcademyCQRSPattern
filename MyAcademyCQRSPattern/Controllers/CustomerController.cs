...
namespace MyAcademyCQRSPattern.Controllers
{
	public class CustomerController : Controller
	{
		...
		public CustomerController(CreateCustomerCommandHandler createCustomerCommandHandler, UpdateCustomerCommandHandler updateCustomerCommandHandler, RemoveCustomerCommandHandler removeCustomerCommandHandler, GetCustomerQueryHandler getCustomerQueryHandler, GetCustomerByIdQueryHandler getCustomerByIdQueryHandler, IMapper mapper)
		{
